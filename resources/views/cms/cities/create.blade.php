                    ...
                    <form method="POST" action="{{route('cities.store')}}" enctype="application/x-www-form-urlencoded">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="city_name_en">{{__('cms.name_en')}}</label>
                                <input type="text" class="form-control" id="city_name_en" name="name_en"
                                    placeholder="{{__('cms.name_en')}}" value="{{old('name_en')}}">
                            </div>
                            <div class="form-group">
                                <label for="city_name_ar">{{__('cms.name_ar')}}</label>
                                <input type="text" class="form-control" id="city_name_ar" name="name_ar"
